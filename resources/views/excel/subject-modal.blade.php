<div class="modal fade" id="subject-modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Upload Subjects Info</h4>
            </div>

            <form action="{{url('subjects-import')}}" method="post" enctype="multipart/form-data">@csrf
