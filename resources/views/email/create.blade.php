           ...
           <div class="modal-content">
            ...
            <form action="{{url('emails')}}" method="post">@csrf
              ...
              <div class="form-group row">
                           ...
                           <div class="col-md-8">
              <input type="email" name="email" class="form-control" placeholder="Enter Your Email" style="padding: 20px;" required>
            </div>
          </div>
              <div class="modal-footer">
               <button type="submit" class="btn btn-primary justify-content-center">Reset Password</button>
               <button type="submit" style="float:left; width:20%" class="btn btn-danger" data-dismiss="modal">Close</button>
