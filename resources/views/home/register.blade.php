        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="gender" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}">
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('Interests') }}</label>
                            <div class="col-md-6">
                         <select class="myselect control-form" name="id[]" multiple="multiple" data-placeholder="Select Your Interests Area">
