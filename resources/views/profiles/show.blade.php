            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="{{url('images/'.Auth::guard('student')->user()->image)}}" alt="User profile picture">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>Username</b> <a class="pull-right">{{ Auth::guard('student')->user()->username }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Phone</b> <a class="pull-right">{{ Auth::guard('student')->user()->phone }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Date of Birth</b> <a class="pull-right">{{ Auth::guard('student')->user()->dob }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Age</b> <a class="pull-right">{{ Carbon\Carbon::createFromDate( Auth::guard('student')->user()->dob)->diff(Carbon\Carbon::now())->format('%y years %m months %d days') }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Gender</b> <a class="pull-right">{{ Auth::guard('student')->user()->gender }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Address</b> <a class="pull-right">{{ Auth::guard('student')->user()->address }}</a>
                            </li>
                        </ul>
                        <a href="{{$user->id.'/edit'}}" class="btn btn-primary btn-block"><b>Edit Profile</b></a>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
